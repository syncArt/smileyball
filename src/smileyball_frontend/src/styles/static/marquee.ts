...
export const colors = {
  ...
  marqueeLeftMiddle: scale(["#FEBC24", "#FE8059"])(
    LEFT_LABEL_LINEAR_GRADIENT_START,
  ).hex(),
  marqueeLeftEnd: "#FE8059",
  marqueeRightStart: "#FE6471",
  marqueeRightMiddle: scale(["#FE6471", "#FE25A7"])(
    RIGHT_LABEL_LINEAR_GRADIENT_START,
  ).hex(),
